...
import { CfnInstance, CfnInternetGateway, CfnRoute, CfnRouteTable, CfnSecurityGroup, CfnSubnet, CfnSubnetRouteTableAssociation, CfnVPC, CfnVPCGatewayAttachment } from 'aws-cdk-lib/aws-ec2';
...
export class Lab6 extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const subnet1 = new CfnSubnet(this, 'MySubnet', {
      ...
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'MySubnet'}]
    })
