...
export class Lab8 extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    super(scope, id, props);

    this.templateOptions.description =
      'Deploy an Auto Scaling Group using a custom launch template with a user-data script, integrated with an Application Load Balancer and target group, plus a scaling policy.';
    ...
    const myAutoScalingGroup = new CfnAutoScalingGroup(this, 'MySCG', {
      ...
      vpcZoneIdentifier: [
        subnet1.attrSubnetId,
        subnet2.attrSubnetId,
        subnet3.attrSubnetId,
        subnet4.attrSubnetId,
      ],
      ...
      targetTrackingConfiguration: {
        ...
        predefinedMetricSpecification: {
          ...
          resourceLabel: Fn.join('/', [
            ...
            Fn.select(
              1,
              Fn.split('targetgroup/', targetGroup.attrTargetGroupArn),
            ),
          ]),
        },
      },
