...
export class Lab8 extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    this.templateOptions.description = 'Deploy an Auto Scaling Group using a custom launch template with a user-data script, integrated with an Application Load Balancer and target group, plus a scaling policy.'
