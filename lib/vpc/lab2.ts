...
export class Lab2 extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const subnet1 = new CfnSubnet(this, 'Public-1A', {
      ...
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'Public-1A'}]
    })
    ...
    const subnet2 = new CfnSubnet(this, 'Public-1B', {
      ...
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'Public-1B'}]
    })
    ...
    const subnet3 = new CfnSubnet(this, 'Private-1A', {
      ...
      availabilityZone: 'us-east-1a',
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'Private-1A'}]
    })
    ...
    const subnet4 = new CfnSubnet(this, 'Private-1B', {
      ...
      availabilityZone: 'us-east-1b',
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'Private-1B'}]
    })

    //* Create 2 Route Tables
    const publicRt = new CfnRouteTable(this, 'Public-RT', {
      vpcId: vpc.attrVpcId,
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'Public-RT'}]
    })

    const privateRt = new CfnRouteTable(this, 'Private-RT', {
      vpcId: vpc.attrVpcId,
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'Private-RT'}]
    })
    ...
    new CfnInstance(this, 'MyEC2', {
      ...
      tags: [{key: 'project', value: 'myapp'}, {key: 'Name', value: 'MyEC2'}]
    })
  }
}
